...
If invoking this module within an environment where unit testing makes sense as part of CI, by setting the "codebuild_can_run_unit_test" argument to true
